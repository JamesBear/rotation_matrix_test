...
namespace LinearAlgebra.UnitTests
{
    ...
    /// <summary>
    ///This is a test class for MatrixBase_RowAccessorTest and is intended
    ///to contain all MatrixBase_RowAccessorTest Unit Tests
    ///</summary>
    [TestClass()]
    public class MatrixBase_RowAccessorTest
    {
        ...
        public void ItemTestHelper<T, T1>()
        {
            ...
            MatrixBase<T>.RowAccessor<T> target = new MatrixBase<T>.RowAccessor<T>(dataView); // TODO: Initialize to an appropriate value
        ...
        {
            MatrixBase<T> dataView = null; // TODO: Initialize to an appropriate value
            IEnumerable target = new MatrixBase<T>.RowAccessor<T>(dataView); // TODO: Initialize to an appropriate value
        ...
        /// <summary>
        ///A test for RowAccessor`1 Constructor
        ///</summary>
        public void MatrixBase_RowAccessorConstructorTestHelper<T, T1>()
        {
            MatrixBase<T> dataView = null; // TODO: Initialize to an appropriate value
            MatrixBase<T>.RowAccessor<T> target = new MatrixBase<T>.RowAccessor<T>(dataView);
            Assert.Inconclusive("TODO: Implement code to verify target");
        }

        [TestMethod()]
        public void MatrixBase_RowAccessorConstructorTest()
        {
            MatrixBase_RowAccessorConstructorTestHelper<GenericParameterHelper, GenericParameterHelper>();
        }
    }
}
